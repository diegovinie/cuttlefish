defmodule CuttlefishWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Cuttlefish.MyChannel do
        use CuttlefishWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :cuttlefish,
                        pubsub_server: Cuttlefish.PubSub
end
